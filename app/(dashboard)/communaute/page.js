...
import { MessageSquare, ThumbsUp, Users, Search, Plus } from 'lucide-react'
          ...
          <div className="md:col-span-3 space-y-4">
            <div className="flex items-center gap-4 mb-6">
              <div className="relative flex-1">
                ...
                <input type="text" placeholder="Rechercher une discussion..." value={recherche} onChange={(e) => setRecherche(e.target.value)} className="w-full pl-12 pr-4 py-3 rounded-xl outline-none text-sm" style={{ backgroundColor: '#0D0D0D', color: '#fff', border: '1px solid #333' }} />
              </div>
