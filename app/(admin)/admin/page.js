...
import { BookOpen, Users, Award, Calendar, ShoppingBag, TrendingUp, Bell, ChevronRight, Star, MessageSquare } from 'lucide-react'
      ...
      <nav style={{ backgroundColor: '#96121c' }} className="w-full shadow-lg">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
            <Link href="/dashboard" className="text-white text-sm font-semibold border-b-2 pb-1" style={{ borderColor: '#9b8e56' }}>Accueil</Link>
          ...
          <div className="flex items-center gap-4">
            ...
            <button onClick={handleLogout} className="text-red-100 hover:text-white text-xs transition-colors">
              Deconnexion
            </button>
          </div>
        </div>
          ...
          <div className="md:col-span-2 space-y-8">
            ...
            <div className="rounded-xl p-6" style={{ backgroundColor: '#0D0D0D' }}>
              <div className="flex items-center justify-between mb-6">
                ...
                <Link href="/cours" className="text-xs font-semibold hover:opacity-80" style={{ color: '#9b8e56' }}>
                  Voir tout
                </Link>
              </div>
              {loading ? (
            ...
            <div className="rounded-xl p-6" style={{ backgroundColor: '#0D0D0D' }}>
              <div className="flex items-center justify-between mb-6">
                ...
                <Link href="/communaute" className="text-xs font-semibold hover:opacity-80" style={{ color: '#9b8e56' }}>
                  Voir tout
                </Link>
              </div>
              {loading ? (
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-xl p-6" style={{ backgroundColor: '#0D0D0D' }}>
              <div className="flex items-center justify-between mb-5">
                ...
                <Link href="/evenements" className="text-xs font-semibold hover:opacity-80" style={{ color: '#9b8e56' }}>
                  Voir tout
                </Link>
              </div>
              {loading ? (
            ...
            <div className="rounded-xl p-6" style={{ backgroundColor: '#0D0D0D' }}>
              ...
              <Link href="/profil" className="block text-center text-sm font-semibold py-2 rounded-lg hover:opacity-90" style={{ backgroundColor: '#1a1a1a', color: '#9b8e56' }}>
                Voir mon profil complet
              </Link>
              {user.role === 'admin' && (
                <Link href="/admin" className="block text-center text-sm font-semibold py-2 rounded-lg hover:opacity-90 mt-2" style={{ backgroundColor: '#96121c', color: '#fff' }}>
                  Panneau Admin
                </Link>
              )}
            </div>
